...
class OrderFeedLocators:
    ...
    MODAL_ORDER_BOX = (By.CSS_SELECTOR, ".Modal_modal_opened__3ISw4 .Modal_modal__container__Wo2l_")
    ...
    ORDER_IS_IN_THE_PROCESS = (By.XPATH, ".//ul[@class='OrderFeed_orderListReady__1YFem "
